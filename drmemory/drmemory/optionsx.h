...
OPTION_CLIENT_STRING(drmemscope, fuzz_module, "",
                     ...
                     "The fuzz target module name. The application main executable is used by default.")
OPTION_CLIENT_STRING(drmemscope,dynamorio_root, "",
                     "The root of dynamorio",
                     "The root of dynamorio")
...
/* WDFuzzer: setup options */
OPTION_CLIENT_STRING(drmemscope, pipe_name, "\\\\.\\pipe\\afl_pipe_",
                     "pipe name for communication with afl",
                     "")
OPTION_CLIENT_STRING(drmemscope, shm_name, "afl_shm_",
                     "shared memory for coverage",
                     "")
OPTION_CLIENT_STRING(drmemscope, fuzzer_id, "default",
                     "fuzzer_id given by afl",
                     "")
OPTION_CLIENT_STRING(drmemscope, coverage_module, "default",
                     "target modules",
                     "")
OPTION_CLIENT_STRING(drmemscope, coverage_mode, "edge",
                     "edge or bb",
                     "")
OPTION_CLIENT_BOOL(drmemscope, single, false,
                   "run without winafl",
                   "disable coverage instrument and pipe")
OPTION_CLIENT_BOOL(drmemscope, nostop, false,
                   "whether the target program will stop automately",
                   "")
